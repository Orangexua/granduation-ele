<template>
  <div class="pricemanage">
    <div style="margin:50px 0 0 320px" class="price">
      目前新用户电费价格：<el-tag type="danger">{{this.newPrice1}}</el-tag>
    </div>
    <div style="margin:15px 0 0 320px" class="price">
    ...
    <el-form
      ...
      style="width: 360px;margin:150px 0 0 300px"
    >
    ...
    <div class="price" style="margin:100px 0 0 320px">
